...
MINIO_SERVICE_URL=`cat ${CC_BASE_SECRET_FOLDER}/minio-secret/service-url`
...
secret-add "${SECRET}" "${MINIO_SERVICE_URL}" "RCLONE_CONFIG_S3_ENDPOINT" 
...
OVR="${CC_APP_DEPLOY_FOLDER}/${APP_NAME}-deploy.yaml"
